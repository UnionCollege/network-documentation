...
router.get('/network/map/add', function (req, res, next) {
  res.render('network/add/map', {
    title: 'Add Panel'
  })
})

router.get('/network/map/:node/:panel/:num', function (req, res, next) {
  PatchDB.findOne({
...
router.post('/network/map/add', savePatch)
router.post('/network/map/:node/:panel/:num', savePatch)
